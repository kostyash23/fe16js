...
const getUsersByGender = (users, gender) => users.filter(el => el.gender === gender).map(el => el.name);
...
const getTotalBalance = users => users.reduce((toatalBalance, el) => toatalBalance + el.balance, 0);
